...
<head>
    <meta charset="utf-8">
    <title>{{ $header->nomor_permintaan }} - Surat Permintaan Barang</title>
    <style>
...
<body>
    ...
    <div class="header">
        ...
        <div class="doc-title">
            ...
            <div class="nomor">{{ $header->nomor_permintaan }}</div>
        </div>
    </div>
    ...
    <table class="meta-table">
        ...
        <tr>
            ...
            <td><span class="status-badge">{{ ucwords($header->status) }}</span></td>
        </tr>
        <tr>
