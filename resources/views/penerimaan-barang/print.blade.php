...
<head>
    <meta charset="utf-8">
    <title>{{ $header->nomor_penerimaan }} - Bukti Penerimaan Barang</title>
    <style>
...
<body>
    ...
    <div class="header">
        ...
        <div class="doc-title">
            ...
            <div class="nomor">{{ $header->nomor_penerimaan }}</div>
        </div>
    </div>
    ...
    <table class="meta-table">
        ...
        <tr>
            <td class="label">Nomor Faktur Supplier</td>
            <td>{{ $header->nomor_faktur_supplier ?: '-' }}</td>
        </tr>
        <tr>
    ...
    <table class="items">
        <thead>
            <tr>
                ...
                <th style="width: 90px;" class="num">Qty Diterima</th>
                <th style="width: 120px;" class="num">Harga Beli</th>
        ...
        <tbody>
            @foreach ($items as $index => $item)
                <tr>
                    ...
                    <td class="num">{{ rtrim(rtrim(number_format($item->qty_diterima, 2, '.', ''), '0'), '.') }}</td>
